...
Spring Boot 简化了 Spring Framework，可以帮助我们非常快速的构建应用程序、简化开发、提高效率。Spring Boot 主要做了两件事，起步依赖和自动配置。
...
## `@SpringBootApplication`：引导 Spring Boot 应用

`@SpringBootApplication` 注解标识在 Spring Boot 工程引导类上，是 Spring Boot 中最最最重要的注解。该注解由三个部分组成：
